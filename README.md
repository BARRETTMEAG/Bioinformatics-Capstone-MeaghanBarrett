...
| **FigTree** | This tool allows for the nwk tree to be seen|
...
# Key Parameters & Choices <br>
   ...
   - BAKTA: Used for genome annotation.
       - BAKTA dataset: bakta_db
        ...
        - CPU used: 4-8 (This is adjustable depending on needs)
        - Assembly meterics:
   ...
   - PANAROO: Used for pangenome investigation.
        ...
        - CPU used: 4 (Adjustable per needs)
        - Assembly metrics:
            - Number of genomes annotated: 9
            - Outputs files per genome:
...
| **core_pan** | PANAROO Files |
| **core_pan/core_gene_alignment_filtered.aln** | ALN file containing the filtered core gene alignment |
| **core_pan/final_graph.gml** | GML file showing the final graph|
| **core_pan/gene_presence_absence.Rtab** | Rtab file showing the presence and absence of genes |
